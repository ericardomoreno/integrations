...
groupName.push(att)})
groupName.forEach((group)=>{var images=document.querySelectorAll(`[zoombox=${group}]`);images.forEach((img,index)=>{img.onclick=()=>{var groupName=img.getAttribute('zoombox');zoombox=new zoomboxImages(`[zoombox=${groupName}]`,img.src,img.getAttribute('src2'),img.alt,index);console.log('execute');zoombox.execute();document.querySelector('.zoombox-close').src=`${clientRootDir}images/close.png`;document.querySelector('.zoombox-zoom-in').src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb3a08b7d24a3d0b21cd04_zoom-in.svg`;document.querySelector('.zoombox-zoom-out').src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb6ba1617f8f942034_zoom-out.svg`;document.querySelector('.zoombox-next').src=`${clientRootDir}images/next.png`;document.querySelector('.zoombox-prev').src=`${clientRootDir}images/prev.png`;document.querySelector('.zoombox-play').src=`${clientRootDir}images/play.png`}})})}
