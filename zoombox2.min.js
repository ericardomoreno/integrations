...
<img class='zoombox-image slide' src='${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb9ce0cf1ee2edafa2_load.svg'>
...
<img class='zoombox-close zoombox-controls' src='${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb626bfde909fefede_close.png'>
<img class='zoombox-next zoombox-controls' src='${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb7b8b672ee08efe17_next.png'>
<img class='zoombox-prev zoombox-controls' src='${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb61c719ba7a56decc_prev.png'>
<img class='zoombox-play zoombox-controls' src='${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb6ba1617f8f94203a_play.png'>
<img class='zoombox-zoom-in zoombox-controls' src='${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb3a08b7d24a3d0b21cd04_zoom-in.svg'>
<img class='zoombox-zoom-out zoombox-controls' src='${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb6ba1617f8f942034_zoom-out.svg'>
...
checkPlay(isplay){this.zoomboxImage.style.transform=` translate(-50%,-50%) scale(1)`;if(isplay){this.isplaying=!1;this.zoomboxPlay.src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb6ba1617f8f94203a_play.png`;clearTimeout(this.slideTimeOut)}else{this.isplaying=!0;this.zoomboxPlay.src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb1ae7e40e966b47d1_pause.png`;this.slideShow()}}
...
groupName.push(att)})
groupName.forEach((group)=>{var images=document.querySelectorAll(`[zoombox=${group}]`);images.forEach((img,index)=>{img.onclick=()=>{var groupName=img.getAttribute('zoombox');zoombox=new zoomboxImages(`[zoombox=${groupName}]`,img.src,img.getAttribute('src2'),img.alt,index);console.log('execute');zoombox.execute();document.querySelector('.zoombox-close').src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb626bfde909fefede_close.png`;document.querySelector('.zoombox-zoom-in').src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb3a08b7d24a3d0b21cd04_zoom-in.svg`;document.querySelector('.zoombox-zoom-out').src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb6ba1617f8f942034_zoom-out.svg`;document.querySelector('.zoombox-next').src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb7b8b672ee08efe17_next.png`;document.querySelector('.zoombox-prev').src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb61c719ba7a56decc_prev.png`;document.querySelector('.zoombox-play').src=`${clientRootDir}https://uploads-ssl.webflow.com/65f8874aa0dc27edf48310d8/65fb39fb6ba1617f8f94203a_play.png`}})})}
